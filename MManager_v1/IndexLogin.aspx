<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="IndexLogin.aspx.cs" Inherits="IndexLogin" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentWeb" Runat="Server">
    ...
    <asp:Label ID="lblMensajes" runat="server" Text="Datos User"></asp:Label>
</asp:Content>
